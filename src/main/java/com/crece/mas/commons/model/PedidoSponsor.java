...
public class PedidoSponsor {
    ...
    @Column(name = "pes_orden_compra_guid")
    private String ordenCompraGuid;

    @Column(name = "pes_monto_descuento_global")
    private BigDecimal pesMontoDescuentoGlobal;

    @Column(name = "pes_porcentaje_descuento_global")
    private BigDecimal pesPorcentajeDescuentoGlobal;

    @Column(name = "pes_tipo_descuento_global")
    private RegardEnumerator pesTipoDescuentoGlobal;
}
